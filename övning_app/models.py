...
class Fråga(models.Model):
    Övning = models.ForeignKey(Övning, related_name='question', on_delete=models.CASCADE)
...
class Alternativ(models.Model): #Svaren
    question = models.ForeignKey(Fråga, related_name='choise', on_delete=models.CASCADE, blank=True, null=True)
